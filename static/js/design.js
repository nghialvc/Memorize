...
{
	var btn = "<button class='col-4 btn btn-success font-weight-bold' style='padding:10px;margin:20px 10px 20px 10px;font-size:36px;' onclick='btn_"+name+"_onclick()'>"+name+"</button>";
	return btn;
}
...
function showSquare(row, col)
{
	...
	var btnready = newButton("Ready")
	var position = "<div class='col-2 font-weight-bold text-center text-white bg-secondary rounded-pill' style='font-size:48px;margin:20px;'>"+Cols[col]+Rows[row]+"</div>";
